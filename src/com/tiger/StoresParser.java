...
public class StoresParser {
    public static Root parse(AuthorizationToken token) throws IOException{
        try {
            String[] command = new String[]{"curl", "--insecure", "https://ondemand.rit.edu/api/sites/1312", "-H", "User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:85.0) Gecko/20100101 Firefox/85.0", "-H",
